...
const ORGS_EN: OrgItem[] = [
  {
    ...
    bullets: [
      "Responsible for event equipment and coordinating with the team to ensure needs are fulfilled on time.",
      "Sharpened teamwork, coordination, and time management skills.",
      "Prepared and arranged all equipment needs before and during the event.",
    ],
  ...
  return (
    <section id="organisations" className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8 py-12 md:py-16">
      <div className="text-center mb-8 md:mb-12">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-wide">ORGANISATIONS</h2>
        <p className="text-sm text-white/70 mt-1">Organisational & committee experiences</p>
      </div>
